...
## Entrega 47
- Más margen inferior en exportaciones para evitar cortes abajo.
- Tarjetas de Comayagua y Honduras más altas.
- Imágenes de productos ajustadas con `contain` y espacio interno adicional.
- Mejor respiración visual en bloques de envío y total.
