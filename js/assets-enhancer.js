...
(function () {
  ...
  function loadCss(path) {
    ...
    if (existing) {
      if (path.includes('sdc-ui-redesign-v163.css')) document.head.appendChild(existing);
      return;
    }
