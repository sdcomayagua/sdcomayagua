...
export function initializeData() {
  ...
  // v1.6.5: si una instalación anterior guardó la URL vacía, usar la URL /exec por defecto.
  if (!String(settings.appsScriptUrl || '').trim()) settings.appsScriptUrl = DEFAULT_CONFIG.appsScriptUrl;
