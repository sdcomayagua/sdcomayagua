...
import { renderNav, renderStatusStrip, setViewTitle, setSheetIdLabel, updateDatalists, toast, resetModalLayer } from './ui.js';
...
function handleGlobalClick(event) {
  ...
  if (shortcut) {
    if (shortcut.dataset.filterStatus) state.filters.status = shortcut.dataset.filterStatus;
    else if (shortcut.dataset.viewShortcut === 'inventory') state.filters.status = 'todos';
    return navigate(shortcut.dataset.viewShortcut);
  }
}
